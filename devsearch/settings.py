...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates') # BASE_DIR refers to the base directory. 'templates' is the folder to look for so: in Base Directory look for folder called 'templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
